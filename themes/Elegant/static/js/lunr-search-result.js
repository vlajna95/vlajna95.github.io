...
const resultIntro = `
<h1>Rezultati pretrage za pojam <code>${term}</code></h1>
`;
...
<p class="lunr-search-result-item-body">${body}</p>
</div>
`;
resultRoot.insertAdjacentHTML("beforeend", resultItem);
}
} else {
const resultFailure = `<p class="lunr-result-fail">Nema rezultata za <span class="lunr-search-term">${term}</span>.</p>`;
